...
This is a test run of the new 1d_global.qmd file. Despite this just being a test run, I think the run level 1 results are worth discussing briefly because they are so different between R and python.
...
The python parameter estimates veer off pretty far in just 2 iterations as if the RWSD is much higher than it should be. The R estimates are much more stable.
